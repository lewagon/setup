...
:warning: 注意啦，你**需要**填`gh api ...`命令列出的其中一个电子邮箱。不然，Kitt就没办法跟进你的学习进程。 你选择的电子邮件将**公开**显示在互联网上。GitHub会自动生成一个类似`123098213+USERNAME@users.noreply.github.com`的地址，所以如果你不想让你的真实电子邮件地址公开，应选择这个电子邮件地址。
