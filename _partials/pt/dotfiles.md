...
:x: Caso contrário, [reautentique no GitHub](https://github.com/lewagon/setup/blob/master/{{ build_md }}#github-cli) antes de executar este comando :point_up: novamente.
