...
WINDOWS_LINUX_SUBSYSTEM2 = %w[wsl2_prerequisites intro remote_tools wsl2_install_wsl wsl2_windows_terminal github wsl2_git alumni_platform wls_slack wsl2_vscode].freeze
filenames = {
  'macOS.md' => MAC_OS,
  'UBUNTU.md' => UBUNTU,
