...
WINDOWS_LINUX_SUBSYSTEM2 = %w[wsl2_prerequisites intro remote_tools wsl2_install_wsl wsl2_windows_terminal github wsl2_git alumni_platform wls_slack wsl2_vscode wsl2_dotfiles rbenv_ubuntu rbenv_ruby wsl_browser_variable wls_postgresql checkup].freeze
filenames = {
  'macOS.md' => MAC_OS,
  'UBUNTU.md' => UBUNTU,
