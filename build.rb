...
WINDOWS_LINUX_SUBSYSTEM2 = %w[wsl2_prerequisites github remote_tools wsl2_install_wsl wsl2_windows_terminal intro wsl2_git wsl2_vscode wsl2_oh_my_zsh github_rsa wsl2_nodejs wsl2_dotfiles rbenv_ubuntu rbenv_ruby wsl_browser_variable wls_postgresql checkup alumni_platform wls_slack].freeze
filenames = {
  'macOS.md' => MAC_OS,
  'UBUNTU.md' => UBUNTU,
