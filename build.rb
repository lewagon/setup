...
UBUNTU = %w(intro ubuntu_virtualbox github ubuntu_sublime_text ubuntu_git ubuntu_oh_my_zsh github_rsa dotfiles rbenv rbenv_ubuntu rbenv_ruby ubuntu_postgresql checkup alumni_platform ubuntu_slack)
