...
WINDOWS_LINUX_SUBSYSTEM = %w[wls_disclaimer intro wls_prerequisites github ubuntu_git wls_sublime_text wsl_oh_my_zsh github_rsa wls_dotfiles rbenv_ubuntu rbenv_ruby wsl_browser_variable wls_postgresql checkup alumni_platform wls_slack].freeze
