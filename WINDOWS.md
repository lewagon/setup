...
> Please, **do not use any other code editor** (ex: SublimeText ...) as they might not be compatible with the Windows Subsystem Linux and will create permission issues hard to fix. For now, only Visual Studio Code is fully compatible with WSL.
